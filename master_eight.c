...
#define OUTPUT_REGULATOR RA4
#define OUTPUT_FAN_1 RB4
#define OUTPUT_FAN_2 RB2
#define OUTPUT_FAN_3 RB0
...
//*********FAN PINS************//
#define OUTPUT_REGULATOR_DIR TRISAbits.TRISA4
#define OUTPUT_FAN_1_DIR TRISBbits.TRISB4
#define OUTPUT_FAN_2_DIR TRISBbits.TRISB2
#define OUTPUR_FAN_3_DIR TRISBbits.TRISB0
...
int checkFlag=0;
int CheckFlag2=0;
int PreventFlag_Touch=0;
int PreventFlag_Touch2=0;
int PreventFlag_ManualTo_Panel=0;
...
__delay_ms(2000); 
   ...
   /******************** MANUAL RESPONE STARTS HERE************ */
       ...
       //fan module
       //WHEN WE PRESS THE SWITCH RELAY GOES TO APPLICATION MODE OR NORMALLY OPEN MODE
       if(copy_parentalLockBuffer[7] == CHAR_OFF && INPUTSWITCH7 == OFF && R7 == OFF)
        ...
        //on condtion
       //WHEN WE RELEASE THE SWITCH IT GOES TO REGULATOR MODE OR NORMALLY CONNECTED MODE
